  ...
  sections: [
    {
      ...
      rows: [
        { label: 'Cuarto Delimitado', field: 'cuartoDelimitado' },
    ...
    },
    {
      ...
      rows: [
        ...
        { label: 'Extintor', field: 'extintor' },
        { label: 'Tipo Extintor', field: 'tipoExtintor' },
        { label: 'Extintor Vigente', field: 'extintorVigente' },
    ...
    },
    {
      ...
      rows: [
        ...
        { label: 'Nodos de Voz', field: 'nodosVoz' },
        { label: 'Cableado Ordenado', field: 'cableadoOrdenado' },
      ],
    },
    {
      title: 'EQUIPOS Y RESPALDO',
      rows: [
        { label: 'Switches', field: 'switches' },
        { label: 'Servidores', field: 'servidores' },
        { label: 'Estado de Alarmas', field: 'alarmas' },
        { label: 'UPS', field: 'estadoUPS' },
        { label: 'Sistema Independiente', field: 'sistemaIndependiente' },
        { label: 'Corriente Regulada', field: 'corrienteRegulada' },
        { label: 'Tierra Física Rack/Gab', field: 'tierraRack' },
        { label: 'Tierra Física Switch', field: 'tierraEquipos' },
      ],
    },
  ],
